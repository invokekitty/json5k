...
import invoke.kitty.json5k.deserialization.Json5ElementDecoder
...
import invoke.kitty.json5k.generation.OutputSink
import invoke.kitty.json5k.generation.StringOutputSink
import invoke.kitty.json5k.parsing.FormatParser
import invoke.kitty.json5k.parsing.InjectableLookaheadParser
import invoke.kitty.json5k.parsing.InputSource
import invoke.kitty.json5k.parsing.StringInputSource
import invoke.kitty.json5k.serialization.Json5ElementEncoder
...
sealed class Json5(
    ...
    internal fun <T> decode(deserializer: DeserializationStrategy<T>, reader: InputSource): T {
        ...
        val res = MainDecoder(serializersModule, parser, settings, this).decodeSerializableValue(deserializer)
        parser.next()
        return res
    }
    ...
    internal fun <T> encode(serializer: SerializationStrategy<T>, value: T, sink: OutputSink) {
        ...
        MainEncoder(serializersModule, generator, settings, this).encodeSerializableValue(serializer, value)
